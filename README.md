...
- [x ] Explain the difference between `Relational Databases` and `SQL`.
  A relational database is a table, or a set of data. SQL is a computer language that is used to access and modify this data.
- [x ] Why do tables need a `primary key`?
  Primary keys are necessary to uniquely identify a row of data.
...
- [x ] What do we need in order to have a _many to many_ relationship between two tables.
  We need a third table which is made up of two foreign keys referencing the primary keys from each of the two tables. The two foreign keys together form a unique id for each relationship.
